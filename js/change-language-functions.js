var languageContent = {
    greek: {
      languageBtn: "EL",
      mainTitle: "Αποζημίωση οπτικών(γυαλιών ή φακών επαφής)",
      pageTitle: "Αποζημίωση οπτικών(γυαλιών ή φακών επαφής)",
      infoTitle: "Πληροφορίες για την αποζημίωση οπτικών(γυαλιών ή φακών επαφής)",
      subTitle1: "Αυτό το ερωτηματολόγιο μπορεί να σας βοηθήσει να βρείτε αν δικαιούστε να λάβετε την αποζημίωση.",
      ...
      and: "και",
      student1: "Γρούιος Στυλιανός",
      student2: "Συμεών Γιαννόπουλος",
    ...
    english: {
      languageBtn: "EN",
      mainTitle: "Compensation for optics (glasses or contact lenses)",
      pageTitle: "Compensation for optics (glasses or contact lenses)",
      infoTitle: "Information on compensation for optics (glasses or contact lenses)",
      subTitle1: "This questionnaire can help you find out if you are eligible to receive compensation.",
      ...
      footerText: "This project was created for the needs of our work during our undergraduate studies at the University of Macedonia. Our team consists of 2 students of Applied Informatics:",
      and: "and",
      student1: "Grouios Stylianos",
      student2: "Symeon Giannopoulos",
